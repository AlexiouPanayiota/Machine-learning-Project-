...
author: "Harken Alexiou Panayiota"
date: "13/2/2021"
...
table(TrainTrainingSet$classe)
table=prop.table(table(TrainTrainingSet$classe))


barplot(table(TrainTrainingSet$classe), col=c("yellow","red","blue","green","purple"), 
     main="Plot of levels of variable classe within the TrainTrainingSet data set", xlab="classe", ylab="Frequency")
...
```
```{r}
levels(TestTrainingSet$classe)
TestTrainingSet$classe=as.factor(TestTrainingSet$classe)
# Test results on our TestTrainingSet data set:
confusionMatrix(prediction1, TestTrainingSet$classe)
```

## Submission
Here is the final outcome based on the Prediction Model applied against the Testing dataset
```{r}
